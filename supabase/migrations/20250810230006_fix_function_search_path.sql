...
-- Note: These functions will be created when the notifications table is added

-- Note: Other notification functions will be created when the notifications table is added
