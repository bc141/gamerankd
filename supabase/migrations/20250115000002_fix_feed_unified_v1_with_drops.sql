-- Fix feed_unified_v1 view by dropping dependent views first
-- This migration handles the dependency issues
...
-- Now recreate the feed_unified_v1 view with correct schema
